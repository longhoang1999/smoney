    ...
    <div class="main-content">
                ...
                <div class="block-register">
                    ...
                    <form action="{{ route('student.register') }}" class="register-form" method="post">
                        ...
                        <div class="register-confirm register-parent">
                            <label for="input-confirm" class="register-label register-label-longtext">Nhập lại mật
                                khẩu</label>
        ...
        <div class="block-rules">
            ...
            <div class="block-rules-content">
                Smoney được phép sử dụng các thông tin do người dùng đăng ký để thực hiện tất cả các hoạt động liên quan
                nhằm kết nối giữa người đi vay và người cho vay.
                <br><br>
                Smoney có quyền thay đổi các quy định sử dụng phần mềm mà không cần báo trước và không cần sự chấp thuận
                của người dùng. Các thay đổi và hiệu lực áp dụng của các thay đổi sẽ được công bố bằng hình thức mà
                Smoney cho là phù hợp.
                <br><br>
                Đơn đăng ký này cùng các điều kiện, điều khoản điều kiện tạo nên một hợp đồng pháp lý giữa tôi và
                Smoney.
                <br><br>
                Bằng việc tích vào ô đồng ý đăng ký tài khoản trên Smoney, tôi xác nhận đã nhận, đã đọc, hiểu rõ và đồng
                ý với các điều khoản và điều kiện trên.”
            </div>
        </div>
    </div>
    <!-- modal -->
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h6 class="text-info font-italic mb-2 font-weight-bold">Bạn có thể xác nhận tài khoản của bạn thông
                        qua số điện thoại hoặc email bạn đã đăng ký!</h6>
                    ...
                    <div class="sendEmailSuccess">
                        ...
                        <span>Hãy truy cập Email của bạn để xác thực tài khoản, sau đó làm theo các bước hướng dẫn để
                            lấy lại mật khẩu tài khoản của bạn</span>
                    </div>
                    <div class="sendEmailFail">
                        <p class="font-weight-bold text-danger mb-1 mt-2">Gửi Email xác thực thất bại!</p>
                        <span>Chúng tôi không thể gửi Email xác thực đến Email của bạn. Vui lòng liên hệ: số điện thoại
                            <span class="font-italic text-info">012345678</span> hoặc email: <span
                                class="font-italic text-info">abc@gmail.com</span> để được hỗ trợ</span>
    ...
    <div class="modal fade" id="CantFindPhone" role="dialog" aria-labelledby="CantFindPhoneLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h6 class="text-danger font-italic font-weight-bold">Số điện thoại của bạn chưa được đăng ký trong
                        hệ thống</h6>
                </div>
            </div>
        </div>
