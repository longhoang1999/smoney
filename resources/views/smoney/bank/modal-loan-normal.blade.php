...
<div class="modal-dialog modal-xl">
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <table class="customTable">
                <tbody>
                    <tr>
                        ...
                        <td>
                            <span class="text-primary">{{ $hs->hoten }}</span>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <span class="text-primary">{{ $hs->uni['nt_ten'] }}</span>
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td>
                            <span>Tổng số tiền bạn phải trả trong suốt kỳ hạn</span>
                        </td>
                        <td>
                            <span class="text-primary">
                                <?php 
        ...
        <h5 class="mb-3">Thông tin hồ sơ của sinh viên - Ngày gửi: {{ date("h:i A d-m-Y", strtotime($hs->created_at)) }}</h5>
                    ...
                    <tbody>
                        ...
                        @if($hs->yourjob['jobstatus'] != "3")
                            ...
                            <tr>
                                ...
                                <td>
                                    <span>
                                        {{ number_format($hs->yourjob['money']) }} VNĐ
                                    </span>
                                </td>
                            </tr>
                        @endif
